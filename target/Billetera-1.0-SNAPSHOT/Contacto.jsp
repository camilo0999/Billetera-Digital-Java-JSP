<%-- 
    Document   : Contacto
    Created on : 12 sept 2024, 11:47:59
    Author     : camilo
--%>
...
<head>
    ...
    <title>WalletUniversity - Contacto</title>
...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <nav
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="Contacto.jsp"
                            class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500">Contacto</a>
                    </li>
                </ul>
            </div>
        </div>
      ...
      <!-- Contacto Section -->
    <section class="pt-20">
        <div class="max-w-screen-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold text-center mb-6 text-gray-900 dark:text-white">Contáctanos</h2>
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Dirección:</h3>
                <p class="text-gray-700 dark:text-gray-300">Calle 55a 39-29, Ciudad Buenaventura, Colombia</p>
            </div>
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Teléfono:</h3>
                <p class="text-gray-700 dark:text-gray-300">+57 (601) 563 1283</p>
            </div>
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Correo Electrónico:</h3>
                <p class="text-gray-700 dark:text-gray-300">contacto@WalletUniversity.com</p>
            </div>
            <div>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Ubicación:</h3>
                <iframe class="w-full h-64 mt-2" 
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15910.460258251617!2d-77.01329107331772!3d3.886830144073599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e30b2cf120b1573%3A0x40821c0e361a0b12!2sBuenaventura%2C%20Valle%20del%20Cauca%2C%20Colombia!5e0!3m2!1ses!2sco!4v1693848503721!5m2!1ses!2sco" 
